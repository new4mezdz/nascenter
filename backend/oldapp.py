...
# 替换 oldapp.py 中的 rename_node 函数 (约第 808 行)
...
# 文件: nascenter/backend/oldapp.py
...
@app.route('/api/nodes/<node_id>/upload', methods=['POST'])
@login_required
...
@app.route('/api/nodes/<node_id>/download', methods=['GET'])
@login_required
@permission_required('readonly')
...
@app.route('/api/nodes/<node_id>/mkdir', methods=['POST'])
@login_required
@permission_required('readwrite')
...
@app.route('/api/nodes/<node_id>/preview', methods=['GET'])
@login_required
@permission_required('readonly')
